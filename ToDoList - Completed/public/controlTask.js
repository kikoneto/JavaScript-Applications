    ...
    element.addEventListener('click', (e) => {
        if (e.currentTarget) {
            ...
            if (currentNode.childNodes[1].tagName === 'H4') {
                taskName = currentNode.childNodes[1].innerText;
                if (currentNode.childNodes[3].tagName === 'DIV') {
                    taskInfo = currentNode.childNodes[3].innerText;
                }
            } else if (currentNode.childNodes[0].tagName === 'H4') {
                taskName = currentNode.childNodes[0].innerText;
                if (currentNode.childNodes[1].tagName === 'DIV') {
                    taskInfo = currentNode.childNodes[1].innerText;
                }
            }
