...
addTaskButton.addEventListener('click', (e) => {
    let title = e.currentTarget.parentNode.childNodes[3].childNodes[1].value;
    let info = e.currentTarget.parentNode.childNodes[3].childNodes[3].value;
    ...
    if (title !== '') {
        ...
        e.currentTarget.parentNode.childNodes[3].childNodes[1].value = '';
        e.currentTarget.parentNode.childNodes[3].childNodes[3].value = '';
    } else {
